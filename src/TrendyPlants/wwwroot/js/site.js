...
//Initialise calculator function

function initialiseCalculator() {

    let buttonWithColourChange = document.getElementById("fencelength");

    //Change the text colour on mouseover
    buttonWithColourChange.addEventListener("mouseover", function handleMouseOver() {
        buttonWithColourChange.style.backgroundColor = "#63a621";
        buttonWithColourChange.style.color = "white";


    });
    //Change text color back on mouseout

    buttonWithColourChange.addEventListener("mouseout", function handleMouseOut() {
        buttonWithColourChange.style.backgroundColor = "";
        buttonWithColourChange.style.color = "";
    });
}
